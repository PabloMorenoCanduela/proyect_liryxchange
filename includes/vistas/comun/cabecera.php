...
<header id="cabecera">
                <a href="./index.php">
                    <img src="./resources/logo.png"  alt="Logo" height="80px" id="logo-cabecera">
                </a>
                
                <a href="./index.php">
                <img src="./resources/nombre.png"    alt="Nombre" height="80px" id="nombre-cabecera">
                </a>
       
                <!--Botón-->
                <form method="post">
                    <button type="submit" name="mostrarOcultar" id="menu-cabecera">
                            <img src="./resources/menu.png" alt="Menu" height="70px" width="70px" id="boton-menu-cabecera">
                    </button>
                </form>
     </header>
